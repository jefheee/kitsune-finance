    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-6">
        <div className="flex items-start gap-4">
          ...
          <div className="bg-[#121212] border border-white/5 rounded-2xl rounded-tl-none p-4 max-w-[85%] md:max-w-[70%]">
      ...
      <div className="p-4 border-t border-white/5 bg-[#0A0A0A]">
        <div className="flex items-center gap-2 bg-[#121212] border border-white/10 rounded-full p-2 pl-4 focus-within:border-kitsune/50 transition-colors">
          <input 
            type="text" 
          ...
          />
          <button className="w-10 h-10 rounded-full bg-kitsune text-[#0A0A0A] flex items-center justify-center hover:bg-kitsune/90 transition-colors">
