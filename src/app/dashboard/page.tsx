  ...
  return (
    <div className="flex flex-col gap-6 p-6">
      <header className="flex flex-col gap-2">
        <h1 className="text-2xl font-bold font-sans text-gray-900 dark:text-white">Dashboard</h1>
        <p className="text-gray-500 dark:text-white/50 text-sm font-sans">Sua visão financeira consolidada.</p>
      </header>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="flex flex-col bg-white dark:bg-[#121212] border border-gray-200 dark:border-white/5 rounded-2xl p-6">
          ...
          <div className="flex items-center gap-2 mt-4">
            ...
            <span className="text-gray-400 dark:text-white/30 text-xs font-sans">este mês</span>
          </div>
        </div>
